...
#pragma endregion
	...
	int m1_cl1_pr1 = 22.77, m1_cl1_pr2 = 57.43; // среднее значение признаков класса 1 для 1-го узла
	int m2_cl1_pr1 = 60.07, m2_cl1_pr2 = 32.60; // среднее значение признаков класса 1 для 2-го узла
	int m3_cl1_pr1 = 49.53, m3_cl1_pr2 = 42.47; // среднее значение признаков класса 1 для 3-го узла

	int m1_cl2_pr1 = 31.03, m1_cl2_pr2 = 41.23; // среднее значение признаков класса 2 для 1-го узла
	int m2_cl2_pr1 = 54.80, m2_cl2_pr2 = 57.60; // среднее значение признаков класса 2 для 2-го узла
	int m3_cl2_pr1 = 73.67, m3_cl2_pr2 = 31.93; // среднее значение признаков класса 2 для 3-го узла
